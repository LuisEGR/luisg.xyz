  ...
  <div class="container">
    <div class="footer-content">
      <div class="footer-section">
        <h3>Luis G</h3>
        <p>Developer, Drone Enthusiast, and Creator</p>
        <p>Building amazing digital experiences and capturing stunning aerial perspectives.</p>
      </div>
    ...
    <div class="footer-bottom">
      <p>&copy; {currentYear} Luis G. All rights reserved.</p>
      <p>Built with ❤️ using Svelte</p>
    </div>
  </div>
</footer>
